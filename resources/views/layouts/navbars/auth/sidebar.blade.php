<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-top-end-xl-xl border-radius-bottom-end-xl-xl fixed-start bg-primary"
    id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
            ...
            <span class="ms-3 font-weight-bold">Dashboard Belia</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item pb-2">
                {{-- <a class="nav-link {{ Route::currentRouteName() == 'program.index' ? 'active' : '' }}" --}}
                <a class="nav-link {{ request()->is('*program*') ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Pengurusan Program</span>
                </a>
            </li>

            <li class="nav-item pb-2">
                <a class="nav-link {{ request()->is('*program*') ? 'active' : '' }}" data-bs-toggle="collapse" href="#programMenu" role="button" aria-expanded="false" aria-controls="programMenu">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                            xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="collapse" id="programMenu">
                    <ul class="nav ms-4">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('*program*') ? 'active' : '' }}"
                                href="{{ route('program.index') }}">
                                <span class="nav-link-text ms-1 text-white">Pengurusan Program</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('*program*') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="laravelExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel-livewire.creative-tim.com/laravel-user-profile">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> User Profile</span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel-livewire.creative-tim.com/laravel-users-management">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Users Management </span>
                            </a>
                        </li>
                                                                        <li class="nav-item ">
                            <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel-livewire.creative-tim.com/laravel-roles-management">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Roles Management </span>
                            </a>
                        </li>
                                                                        <li class="nav-item ">
                            <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel-livewire.creative-tim.com/laravel-category-management">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Category Management </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel-livewire.creative-tim.com/laravel-tags-management">
                                <span class="sidenav-mini-icon"> D </span>
                                <span class="sidenav-normal"> Tags Management </span>
                            </a>
                        </li>
                        <li class="nav-item ">
                            <a class="nav-link " href="https://soft-ui-dashboard-pro-laravel-livewire.creative-tim.com/laravel-items-management">
                                <span class="sidenav-mini-icon"> D </span>
