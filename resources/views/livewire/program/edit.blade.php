    ...
    <div class="container-fluid py-4">
        <div class="card">
            <div class="card-header pb-0 px-3">
                <h6 class="mb-0">{{ __('Create Program') }}</h6>
            </div>
            <div class="card-body pt-4 p-3">
                ...
                <form wire:submit="store" action="#" method="POST" role="form text-left">
                    ...
                    <div class="d-flex justify-content-end my-2">
                        <button type="button" class="btn bg-gradient-dark btn-md mt-4 mb-4 me-2" onclick="window.location='{{ url()->previous() }}'">
                            <span class="btn-inner--icon"><i class="fa fa-backward"></i></span>
                            <span class="btn-inner--text">Back</span>
                        </button>
                        <button type="submit" class="btn bg-gradient-success btn-md mt-4 mb-4">{{ 'Save' }}</button>
                    </div>
                </form>
