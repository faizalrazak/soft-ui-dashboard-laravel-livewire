            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row justify-content-between">
                        <h6 class="col">Program table</h6>
                        <button class="col-2 btn btn-icon btn-3 btn-primary" type="button" wire:click='create'>
                            <span class="btn-inner--icon"><i class="fa fa-plus"></i></span>
                            <span class="btn-inner--text">Create Program</span>
                        </button>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        ...
                        <tbody>
                            ...
                            <td class="align-middle">
                                <button class="col-2 btn btn-icon btn-3 btn-primary" type="button" wire:click='edit'>
